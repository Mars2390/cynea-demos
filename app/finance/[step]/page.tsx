...
import { agent, readyStep, steps } from '@/demos/finance/config';
...
export default function FinanceStepPage({ params }: { params: { step: string } }) {
  if (!isValidStep(params.step)) notFound();
  return <FinanceDemo initialStep={params.step} />;
}
